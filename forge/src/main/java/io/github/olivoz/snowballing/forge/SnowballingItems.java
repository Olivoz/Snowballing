...
public final class SnowballingItems {
    ...
    public static final RegistryObject<Item> SNOWBALL_PILE = REGISTRY.register("snowball_pile", () -> new BlockItem(SnowballingBlocks.SNOWBALL_PILE.get(), new Item.Properties().tab(SnowballingModForge.SNOWBALLING_MOD_TAB)));
